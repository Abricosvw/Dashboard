 ...
 */
// This function is now removed, I2C is initialized in main.

// This function is no longer needed as GPIO is not directly managed here for I2C.
...
void display_init(i2c_master_bus_handle_t bus_handle)
{
    ...
    ESP_LOGI(TAG, "Initializing touch panel with shared I2C bus handle...");
